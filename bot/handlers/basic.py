...
_HELP_TEXT = (
    ...
    "  /setproxy — Reply to a `.txt` proxy file to load proxies\n"
    "  /clearproxy — Remove all loaded proxies\n"
    "  /proxystatus — Show proxy & thread info\n"
    "  /setthreads `<n>` — Set concurrent threads (1–200, default 50)\n\n"
    "**Owner only:**\n"
